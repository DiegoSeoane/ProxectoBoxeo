...
urlpatterns = [
    ...
    path('administracion/eliminar/competidor/<int:competidor_id>/', views.eliminarCompetidor, name='eliminarCompetidor'),
    path('administracion/eliminar/combate/<int:combate_id>/', views.eliminarCombate, name='eliminarCombate'),
    path('administracion/eliminar/evento/<int:evento_id>/', views.eliminarEvento, name='eliminarEvento'),
    path('administracion/engadir/competidor/', views.engadir_competidor, name='engadirCompetidor'),
    path('administracion/engadir/combate/', views.engadir_combate, name='engadirCombate'),
    path('administracion/engadir/evento/', views.engadir_evento, name='engadirEvento'),
